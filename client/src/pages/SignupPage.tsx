        ...
        <div>
          ...
          >
            ...
            <span className="relative inline-block">
              ...
              >
                <path
                  d="M2 5.5C20 1.5 40 1.5 60 4.5C80 7.5 100 2.5 118 4"
                  stroke="#E2A83D"
                  strokeWidth="2.5"
                  strokeLinecap="round"
                />
          ...
          <p className="mt-5 text-base max-w-xs" style={{ color: "#A9ACC9" }}>
            Capture it, format it, find it again, all in one quiet place
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="w-full max-w-sm">
          ...
          <div className="space-y-1.5 mb-4">
            ...
            <input
              ...
              className="w-full rounded-lg px-3 py-2.5 text-sm bg-white focus:outline-none focus:ring-2 focus:border-transparent"
              style={{ border: "1px solid #E4E4EE", boxShadow: "none" }}
          ...
          <p className="text-sm text-center mt-6" style={{ color: "#6B6F86" }}>
            ...
            <Link to="/login" className="font-medium hover:underline" style={{ color: "#1B1F3B" }}>
              Log in
            </Link>
          </p>
        </form>
